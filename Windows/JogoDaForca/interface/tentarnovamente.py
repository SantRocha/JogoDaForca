...
class TelaOpcoes:
    def __init__(self, master, usuario, tema, palavra):
        ...
        self.create_styled_button(button_frame, "Voltar ao Início", self.voltar_inicio, bg="#ff0014", active_bg="#ba0a18").pack(side="left", padx=10)

        # Botão Continuar
        self.create_styled_button(button_frame, "Tentar novamente", self.tentatNovamente, bg="#087631", active_bg="#065A28").pack(side="left", padx=10)
...
def iniciar_tela_novamente(usuario, tema, palavra):
    root = tk.Tk()
